...
<head>
    <meta charset="UTF-8">
    <title>Reset Imail Verification Page</title>
...
<div class="signup-container">
    ...
    <div class="signup-form">
        <h2>Reset Imail Verification</h2>
        ...
        <form action="reset_imail_verification.php" method="POST" autocomplete="off">
            ...
            <div class="form-group">
                <input type="submit" name="check-reset" value="Verify">
            </div>
